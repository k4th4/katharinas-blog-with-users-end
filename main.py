...
#         return render_template('_logged_in.html', name=name)
#     else:
#         return render_template('_login.html', form=login_form)
#
...
# stored at heroku os.environ.get("SECRET_KEY") settings/configvars
